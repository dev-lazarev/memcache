...
(http://golang.org/). This is a high performance fork of the original library at http://github.com/rainycape/memcache (
fork github.com/bradfitz/gomemcache). The following is a comparison between the original library and this one:
